...
class ChatExportService {
  ...
  Future<bool> exportToPostgreSQL(
    ...
    try {
      ...
      // Add DDL
      buffer.writeln('DROP TABLE IF EXISTS "public"."WeTrace"; CREATE TABLE "public"."WeTrace" ("id" int4 NOT NULL GENERATED BY DEFAULT AS IDENTITY ( INCREMENT 1 MINVALUE 1 MAXVALUE 2147483647 START 1 CACHE 1 ), "date" date, "time" time(6), "is_send" bool, "content" text COLLATE "pg_catalog"."default", "send_name" varchar(255) COLLATE "pg_catalog"."default", "timestamp" timestamp(6),   CONSTRAINT "WeTrace_pkey" PRIMARY KEY ("id") );');
      buffer.writeln();
      buffer.writeln('ALTER TABLE "public"."WeTrace" OWNER TO "postgres";');
      buffer.writeln();

      // Add INSERTs
      if (messages.isNotEmpty) {
        buffer.writeln('INSERT INTO "public"."WeTrace" ("date", "time", "is_send", "content", "send_name", "timestamp") VALUES',);
